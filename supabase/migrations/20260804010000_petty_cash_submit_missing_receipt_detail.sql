-- El envío de rendiciones de Caja Chica exige un comprobante por línea, pero
-- el mensaje de error no indicaba cuál línea lo tenía pendiente, lo que
-- confundía a las usuarias (guardaban el borrador sin problema y el envío
-- fallaba sin pista de qué corregir). Se agrega el detalle de las líneas
-- afectadas al mensaje de la excepción.
